...
//    	alert("DEBUGGER - ValidateLine sublistName=" + sublistName + ", mShipAddr=" + mShipAddr + ", ShipAddr=" + shipAddr + ", isLeasing=" + isLeasing);
...
//							message : "Price Level  for item " + sItem + " is different from that on the Entity record Price Level: " + sPriceLevel + ", Currency=" + Currency
					...
					dialog.alert ({
						...
						message : "Price Level  for item " + sItem + " is different from that on the Entity record Customer Price Level: " + sPriceLevel 
					});
				}
			}else {
				bOK = false;
