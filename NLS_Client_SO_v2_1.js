...
//    				bOK = ValidatePriceLevel(currentRecord);    	    		  				
    		...
    		if (iChannel !== CONSTANT_CHANNEL_DIRECT && currentForm !== FORM_INTERCOMPANY && currentForm !== RETAIL_Store_FORM) {
...
//		alert("DEBUGGER - ValidatePriceLevel currentPriceLevel=" + currentPriceLevel);
	...
	//			alert("DEBUGGER - ValidatePriceLevel currentPriceLevel=" + currentPriceLevel + ", headPriceLevel=" + headPriceLevel + ", itemType=" + itemType
